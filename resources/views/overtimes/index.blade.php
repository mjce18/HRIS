...
@section('content')
<div class="mb-6">
    <p class="text-gray-600 dark:text-gray-400">Review and approve employee overtime requests</p>
</div>
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-400">{{ $overtime->date->format('M d, Y') }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-3">
                        @if($overtime->status === 'pending')
                            <form method="POST" action="{{ route('overtimes.approve', $overtime) }}" class="inline">
                                @csrf
                            ...
                            <button onclick="showRejectModal({{ $overtime->id }})" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300">Reject</button>
...
<div id="rejectModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
        <div class="mt-3">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Reject Overtime Request</h3>
...
function showRejectModal(overtimeId) {
    document.getElementById('rejectForm').action = '/overtimes/' + overtimeId + '/reject';
