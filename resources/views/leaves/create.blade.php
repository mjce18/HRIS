...
@section('content')
<div class="mb-6">
    <a href="{{ route('leaves.index') }}" class="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
...
<div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden max-w-2xl">
    ...
    <form method="POST" action="{{ route('leaves.store') }}" class="p-6">
        @csrf
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <a href="{{ route('leaves.index') }}" class="px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                Cancel
            </a>
